...
})({"8yoCd":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "7bd879ddbd0d6e92";
"use strict";
        ...
        <div class="container">
          <div class="content" @click="${(e)=>this._showMoreInfo(e, this.config.entity)}">
            <div class="${iconContainerClass}" id="icon-container">
              ${this.config.icon_sensor && this.hass.states[this.config.icon_sensor] && !isNaN(parseFloat(this.hass.states[this.config.icon_sensor].state)) ? (0, _lit.html)`<span class="${iconSensorClass}" @click="${(e)=>this._showMoreInfo(e, this.config.icon_sensor)}">
                            ${parseFloat(this.hass.states[this.config.icon_sensor].state).toFixed(1)}°
                          </span>` : (0, _lit.html)`<ha-icon icon="${displayIcon}" class="${iconClass}" id="icon"></ha-icon>`}
            </div>
            <div class="label">
...
},{"./switcher-boiler-card-editor.js":"gi9SH","lit":"4antt"}],"gi9SH":[function(require,module,exports,__globalThis) {
var _lit = require("lit");
const SCHEMA = [
    {
        name: "entity",
...
class SwitcherBoilerCardEditor extends (0, _lit.LitElement) {
    static properties = {
        hass: {},
        _config: {}
    };
    ...
    _renderTimerValues() {
      ...
      <div class="timer-values">
        ${timerValues.map((option)=>(0, _lit.html)`
            <label>
              <input
                type="checkbox"
                value="${option.value}"
    ...
    _valueChanged = (ev)=>fireEvent(this, "config-changed", {
...
},{"lit":"4antt"}],"4antt":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["8yoCd","i5KkI"], "i5KkI", "parcelRequire94c2")
